...
@cho.carbon.cfg.annotation.FunctionGroup(value = "DXJDE2020")
public class DXJDE2020BNB implements 
FunctionGroup, IdentityQueryFuncGroup, CheckFuncGroup, ThirdRoundImproveFuncGroup,
